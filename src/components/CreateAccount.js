                                                ...
                                                <div class="row g-0">
                                                    <div class="col-lg-6 was-validated">
                                                        <div class="p-5">
                                                            ...
                                                            <div class="mb-4">
                                                                <div class="form-outline form-white">
                                                                    <input type="text" required value={aadhar} minLength="12" maxLength="12" onChange={e => setAadhar(e.target.value)} class="form-control form-control-lg" />
                                                    ...
                                                    <div class="col-lg-6 bg-indigo text-white was-validated">
                                                        <div class="p-5">
